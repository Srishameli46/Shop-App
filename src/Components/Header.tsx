...
export function Header() {
  return (
    <>
      <nav className="bg-white border border-gray-200 dark:border-gray-700 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 shadow fixed top-0 left-0 w-full z-50">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="w-full md:block md:w-auto hidden" id="mobile-menu">
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-md md:font-medium">
              ...
              <li>
                <NavLink to='/login'>
                  <FontAwesomeIcon icon={faCircleUser} style={{ color: "#fafafa", }} size="xl" />
                </NavLink>
              </li>
            </ul>
