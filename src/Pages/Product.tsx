          ...
          <div key={product.id} className="bg-white rounded-lg shadow-lg p-5 text-center">
            ...
            <div className="flex gap-4">
              <Button onClick={() => addToCart(product)}
                className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-4 focus:ring-green-300 mb-4" children="Add to Cart">
              </Button>
              <Link to={`/products/${product.id}`}>
                <Button className="bg-blue-700 hover:bg-blue-800 text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-4 focus:ring-blue-300" children="View Product"></Button>
              </Link>
            </div>
          </div>
        ))}
